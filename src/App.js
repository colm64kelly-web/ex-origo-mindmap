...
const NOVEL = {
  ...
  branches: [
    ...
    { id:"generations", label:"THREE GENERATIONS", color:C.crimson, icon:"⊗",
      ...
      children:[
        { id:"thomas", label:"THOMAS LOFTUS-BURTON", color:C.crimsonL, detail:"Gen.1. Escapes Boer POW camp with real James Alderton. Hides for months. Alderton reveals a legend before his death: the carvings on the chest (and later the cope's embroidery) encode the location of exceptional mineral wealth in South Africa - a claim Thomas initially dismisses. Murders Alderton in a cave near Makapan Valley - the identity theft was always the visible motive, but Alderton could not be allowed to tell anyone else what he had told Thomas. Walks north along elephant trails 3 years. Arrives Kenya 1906 as Alderton. Marries into Van der Berg family (diamond money) - not chance, but the deliberate conversion of Alderton's revealed knowledge into fortune. Builds tea plantation. Recruited by the organisation. Dies as James Alderton. Named on the Fusiliers' Arch, St Stephen's Green, Dublin, among 222 fallen Royal Dublin Fusiliers, lost in action at the Battle of Colenso, 15 December 1899 — five years before he actually reached Kenya. Has a posthumous grave at St Patrick's Anglican Church, Enniskerry, Co. Wicklow. No body. A headstone for a living man." },
        { id:"doyle", label:"PATRICK DOYLE", color:C.crimsonL, detail:"Gen.2. Insurance assessor, Galway. James Alderton direct descendant. Organisation operative sent to retrieve the chest and cope. The professional breach was always the mission. Causes deaths across Ireland, Italy, France through operational reports. Takes the chest from the Connemara cottage back room and stores it in the basement of his own Galway house — not carried in his car. It sits in the dark under his domestic life while he travels to Dublin, Florence, Puglia, Provence; the chest photograph on his phone is his only connection to it while away. He returns to the basement between operational phases, looks at the chest, does not move it, goes back upstairs. Dies in the Connemara cottage back room." },
        { id:"michael", label:"MICHAEL DOYLE", color:C.crimsonL, detail:"Gen.3. ADOPTED. Organisation-placed. Told what he was leaving boarding school. Loves Doyle genuinely. Summoned from Florence dinner by the organisation. Already in the cottage before Doyle arrives. Steps out of shadows in Ch.27. Kills Browne. Assumes control. After the confrontation, drives to Doyle's Galway house, goes down to the basement, and removes the chest and the cope — the basement empty for the first time since Doyle brought the chest home from Connemara. Drives east. Whether Michael returns for the chest, or the novel closes before this is confirmed, is a structural decision still open. His line: NOW IT IS MINE." },
      ]
    },
    { id:"characters", label:"CHARACTERS", color:C.blue, icon:"◉",
      ...
      children:[
        { id:"michael-academic", label:"MICHAEL — CAMBRIDGE LIFE", color:C.blueL, detail:"Magdalene College, Cambridge. History of Art, final year, Renaissance specialism. Dissertation (working title): Spolia and Afterlife - the reuse and reinterpretation of antique material in ecclesiastical and civic architecture, 1200-1600. Fictional supervisor: Dr Elspeth Farrant. Volunteers at the college's Cripps Gallery - legitimate prior experience handling provenance documentation and condition reports. SURFACE: ordinary college life, close friends who know nothing, fortnightly supervisions, essay panic. TRUE: this life is not a performance - it is real, running in parallel to the organisation, which is the horror of him. His Provence and surrounds research trip (mentioned to Doyle in Florence, Ch.8 PICTURA) is genuine dissertation fieldwork on the surface; TRUE: his first independent organisation contact away from Doyle's knowledge, folded into travel with a clean academic paper trail." },
    ...
    { id:"locations", label:"LOCATIONS", color:C.green, icon:"◈",
      ...
      children:[
        { id:"ireland", label:"IRELAND", color:C.greenL, detail:"Connemara: the fire-damaged cottage, the back room the fire did not reach. Ballynahinch Castle, Recess: the Ranji Room, Owenmore Restaurant, Humanity Dick plaque, Thomas Martin Room. National Museum Kildare Street: Faddan More Psalter, Embroidered Cope, Egyptian false door. National Library: estate papers, the letter in the wrong hand. Fusiliers' Arch, St Stephen's Green: erected 1907, 222 Royal Dublin Fusiliers dead inscribed on the underside, Thomas's name among them, bullet holes from the 1916 Rising still visible, called Traitor's Gate by nationalists — Doyle passes through after the National Library visit and reviews his file on a bench facing the Lord Ardilaun statue nearby. St Patrick's Anglican Church, Enniskerry, Co. Wicklow: Thomas's posthumous grave, no body, a headstone dated to Colenso — Doyle visits in Act I. Doyle's Galway house: the chest stored in the basement throughout the investigation." },
        ...
        { id:"safrica", label:"SOUTH AFRICA THE CAVE", color:C.greenL, detail:"Makapan Valley, Limpopo Province. Where Thomas and Alderton hid for months after escaping the Boer POW camp. The founding crime scene. The chest was present. Chapter: CAEDES. Site visit required before drafting this chapter. REAL-WORLD RESEARCH (folded Aug 2026, source: Wikipedia — verify against underlying journal citations before pitch-facing use): the valley is part of the Cradle of Humankind and contains several named caves including the Historic Cave, curtained by Ficus ingens fig-tree roots at its entrance, with an underground lake and a large colony of migratory long-fingered bats — strong sensory material if the fictional cave is placed within it. The valley is also the real site of an 1854 siege in which Chief Makapan's people were besieged in a cave for nearly a month and many hundreds died of hunger and thirst; the nearby town has since been renamed twice, most recently to Mokopane in the chief's honour. Open question: whether to set the fictional murder within this real, historically weighted site, or keep it fictional-but-nearby — a deliberate-choice flag, not yet resolved." },
      ]
    },
    { id:"chapters", label:"LATIN CHAPTERS", color:C.earth, icon:"I",
      ...
      children:[
        { id:"act1c", label:"ACT I: CUSTOS to TABULA", color:C.earthL, detail:"Ch.0 CUSTOS (Guardian): reconnaissance at the National Museum, followed by the Fusiliers' Arch scene (Thomas's name among the 222 fallen) and the Lord Ardilaun bench (Doyle reviewing his file, chosen for its sightlines). Ch.1 INVENTIO (Discovery): the cottage, mission confirmed, chest taken to Doyle's Galway basement. Ch.2 CONVIVIUM (A Feast): Ballynahinch intelligence lunch. Ch.3 FILIUS (Son): Thomas departing for the Boer War. Ch.4 VIGIL (Watcher): Browne as sleeper operative; Doyle's Enniskerry grave visit. Ch.5 TABULA (Record): War Office list — clean, as the organisation arranged." },
    ...
    { id:"threads", label:"SEVEN THREADS", color:C.violet, icon:"≋",
      ...
      children:[
        ...
        { id:"t8", label:"MEMORIA — Migration and Memory", color:C.violetL, detail:"NEW. Chapter 16 MEMORIA's dedicated thread. The Great Wagon Road (Pennsylvania to North Carolina, an ancient wildlife trail turned settler road, the most heavily travelled road in America by the Revolution) as a structural parallel to Thomas's elephant trail north: an ancient animal migration route becomes a human trail becomes a road becomes a historical artery — the same geography crossed by different peoples across centuries, the terrain unchanged, only the walkers changed. The Great Wagon Road's Scots-Irish travellers share Ulster Protestant stock with the Anglo-Irish landed class Thomas belonged to — some went south to the Carolinas, some stayed in Ireland and accumulated Wicklow estates, Thomas went south through Africa; the impulse of movement, settlement, and displacement is the same. Doyle reads about ancient trails becoming roads somewhere in the Italian or Provence thread, and notes it without connecting it to Thomas — the reader makes the connection." },
      ]
    },
    { id:"openq", label:"OPEN QUESTIONS", color:C.amber, icon:"▶",
      ...
      children:[
        ...
        { id:"oq4", label:"Thomas at Makapan", color:C.amberL, detail:"DECIDED: Alderton reveals to Thomas that the carvings (and later the cope's embroidery) are a coded legend to the location of exceptional mineral wealth - Thomas initially dismisses it. Conviction breaks on the night of 24 April 1901: the Great Comet of 1901 (Comet Viscara), visible almost exclusively from the Southern Hemisphere that spring, appears over the bush as Alderton makes his case. Real, verifiable event - not supernatural, but overwhelming enough to collapse Thomas's disbelief. Gives the murder a second motive beneath the identity theft: Alderton could not be allowed to tell anyone else. STILL OPEN: the actual mechanism by which the carvings/embroidery function as a key across generations, and the nature of the curses hidden within them - to be developed. ALSO STILL OPEN (added Aug 2026): whether the cave is placed within the real, named Makapansgat valley — a documented site of an 1854 siege that killed several hundred people and carries live cultural and political weight in South Africa today — or kept fictional-but-nearby. A deliberate-choice flag, not a blocker, feeding into the existing site-visit requirement." },
...
const GAME = {
  ...
  branches: [
    ...
    { id:"itineraries", label:"FIVE ITINERARIES", color:C.green, icon:"◈",
      ...
      children:[
        { id:"it1", label:"The Irish Journey", color:C.greenL, detail:"3-5 DAYS. IRELAND ONLY. Dublin: National Museum, National Library, Fusiliers' Arch, St Stephen's Green. Galway: Doyle professional world, his Galway house. Connemara: Ballynahinch Castle, bog road toward the Twelve Bens. Enniskerry: the posthumous grave. Unlocks: Browne internal monologue, Dr Sheehy private cope assessment, Loftus-Burton family tree, Rungs 1-4." },
    ...
    <div style={{
      ...
      <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between",
        ...
        <div style={{ display:"flex", alignItems:"center", gap:10 }}>
          ...
          <div style={{ fontSize:8, letterSpacing:2, color:C.muted, textTransform:"uppercase" }}>
            {mode === "novel" ? "Novel Architecture" : "Game Architecture"} v5.1
          </div>
        </div>
      ...
      <div style={{ padding:"6px 16px", borderTop:"1px solid "+C.border, background:C.bgP,
        ...
        <div style={{ fontSize:7.5, color:C.muted, letterSpacing:1 }}>
          {data.branches.length} BRANCHES v5.1 AUG 2026 &middot; BUILD v14 (12 Aug 2026)
        </div>
      </div>
    </div>
  );
